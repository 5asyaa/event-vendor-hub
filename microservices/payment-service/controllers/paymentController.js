  ...
  try {
    ...
    const invoice = await Invoice.createInvoice({
      data: {
        ...
        successRedirectUrl: `http://localhost:3000/views/customer/booking-berhasil.html?id_booking=${id_booking}`,
        failureRedirectUrl: `http://localhost:3000/views/customer/pembayaran.html?id_booking=${id_booking}&status=failed`
      }
    });
